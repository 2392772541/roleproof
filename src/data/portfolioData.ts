...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    delivery: ['独立职位工作区与阶段看板', '严格 Schema 与关系校验', '桌面与 390px 移动端流程', 'GitHub Pages 自动部署', 'PRD、案例复盘、评测与 AI 边界文档'],
    proof: [
    ...
    verifiedMetrics: ['15 条 Vitest 测试', '36 个桌面/移动端 E2E 用例运行', '5 维可解释评分', '100% Evidence ID 合法性校验'],
